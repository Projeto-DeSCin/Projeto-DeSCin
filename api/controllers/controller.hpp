...
public:
    ...
    virtual crow::response get_by_id(const crow::request& req) const = 0; // GET/api/:id
    ...
    virtual crow::response put(const crow::request& req) = 0; // PUT/api/:id
    // This class delete an object by its id.
    virtual crow::response delete(const crow::request& req) = 0; // DELETE/api/:id
};
